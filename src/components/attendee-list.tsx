        ...
        <div className="flex flex-col gap-4">
            <div className="flex gap-3 items-center">
                ...
                <div className="flex gap-3 items-center px-3 w-72 py-1.5 border  border-white/10 rounded-lg">
                    ...
                    <input className="flex-1 outline-none bg-transparent border-0 p-0 text-sm ring-0" placeholder="Buscar participante..." />
                </div>
            </div>
                    ...
                    <thead>
                        <tr className="border-b border-white/10">
                            <th className="py-3 px-4 text-sm font-semibold text-left">
                                <input type="checkbox" className="size-4 bg-black/20 rounded border border-white/10 focus-visible:outline-none checked:text-emerald-300 focus:ring-0 focus:ring-offset-0"/>
                            </th>
                                ...
                                <tr key={i} className="border-b border-white/10 hover:bg-white/5">
                                    ...
                                    <td className="py-3 px-4 text-sm text-zinc-300">
                                        <div className="flex flex-col gap-1">
                                            <span className="font-semibold text-white">Felipe Pitol</span>
